---
title: About - N3RDIUM
description: Hey there! I'm n3rdium. I like basically everything about space, computers and pianos. I also play badminton in my spare time.
...
By the way, you can navigate this site without a mouse! Press `F` to get started. Scroll with `J`/`K` and navigate history with `H`/`L`. `U` and `D` go up and down half the viewport respectively. Requires JavaScript to be enabled.
