...
blog_feed.subtitle(
    "Welcome to my blog! Find weekend projects, not-so-weekend ones, programming posts, random scientific banter and much more."
)
...
astro_feed.subtitle(
    "This is a gallery of all my latest astrophotography, in a pinterest-like bento grid format. Enjoy the spacey-ness!"
)
