...
ScrollTrigger.create({
  ...
  onUpdate: (self) => {
    ...
    const bracket1_x = window.innerWidth / 2 - 160
    const bracket1_newx = 32
    const bracket1_y = window.innerHeight / 2
    const bracket1_newy = 64
    const bracket1_rot = -24
    const bracket1_newrot = 32 + (1 - Math.sin(progress * 4)) * 10
    gsap.to('#bracket1', {
...
function animate (time) {
  ...
  if (scrollY == 0) {
    ...
    const bracket1_x = window.innerWidth / 2 - 160 - mouseX / 16
    const bracket1_y = window.innerHeight / 2 - mouseY / 16
    const bracket1_rot = -24
    gsap.to('#bracket1', {
    ...
    const bracket2_x = window.innerWidth / 2 + 160 - mouseX / 24
    const bracket2_y = window.innerHeight / 2 - 256 - mouseY / 24
    const bracket2_rot = -24
    gsap.to('#bracket2', {
    ...
    const star1_x = window.innerWidth / 2 - 130 - mouseX / 13
    const star1_y = window.innerHeight / 2 - 234 - mouseY / 13
    const star1_rot = 13
    gsap.to('#star1', {
    ...
    const star2_x = window.innerWidth / 2 + 172 - mouseX / 26
    const star2_y = window.innerHeight / 2 + 122 - mouseY / 26
    const star2_rot = 13
    gsap.to('#star2', {
    ...
    const star3_x = window.innerWidth / 2 - 200 - mouseX / 24
    const star3_y = window.innerHeight / 2 + 100 - mouseY / 24
    const star3_rot = 13
    gsap.to('#star3', {
    ...
    const star4_x = window.innerWidth / 2 + 120 - mouseX / 29
    const star4_y = window.innerHeight / 2 - 269 - mouseY / 29
    const star4_rot = 13
    gsap.to('#star4', {
